...
<div class="post_payload">
  ...
  <div class='para'>
    ...
    <div class='x'>
      ...
      The `+` between `a` and `bi` does not mean that we are somehow going to add `a` into `bi`.<br />
      The `+` is simply a convention - we must look at the complex number as pair of two numbers `a` and `bi`.<br />
  ...
  <div class='para'>
    ...
    <div class='x'>
      ...
      Therefore, if every class of numbers before the Imaginary number was arrived at by trying to define that which was previously undefined<br />
      ...
      <br />
      The choice of <math><msqrt><mn>-1</mn></msqrt></math> reminds us of 1; we accept 1, without second thought, as the Multiplicative Identity.<br />
  ...
  <div class='para'>
    ...
    <div class='x'>
      ...
      However, given all the useful applications it has found as a part of the complex number, the Imaginary number has done quite well for itself.<br />
    </div>
  </div>
  <div class='para-brk'></div>
  ...
  <div class='para'>
    ...
    <div class='x'>
      ...
      When pair together as a Complex Number, Real and Imaginary numbers form a powerful mental tool.<br />
