...
for(
  ...
  for(
    ...
    console.log(
      ...
      <br />
      If the Real axis is positioned across the width of the canvas element then we have to map each pixel's X coordinate
...
> real_scale(300)
  1
      ...
      <br />
      Similarly, for the the imaginary axis along the height of the canvas element we need to map each pixel's Y
      coordinate to a Imaginary number.<br />
